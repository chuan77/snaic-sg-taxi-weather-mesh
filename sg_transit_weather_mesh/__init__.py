...
pipeline_execution_job = define_asset_job(
    ...
    selection=["ingest_sg_raw_data", "analytics_taxi_weather_mart", "weather_nowcast_export", "hotspots_export", "taxis_export", "surge_predictor_export", "taxi_clusters_export"]
)
