...
pipeline_execution_job = define_asset_job(
    ...
    selection=["ingest_sg_raw_data", "analytics_taxi_weather_mart", "weather_nowcast_export", "hotspots_export", "taxis_export", "taxi_window_export", "surge_predictor_export", "taxi_clusters_export", "weather_24hr_export", "demand_forecast_export", "chat_context_export", "subzones_export"]
)
